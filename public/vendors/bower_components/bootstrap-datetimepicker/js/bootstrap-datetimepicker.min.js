! function(c) {
    ...
    e.prototype = {
        ...
        place: function() {
            ...
            if (this.component) {
            	...
            	if (this.pickerPosition == "bottom-left" || this.pickerPosition == "top-left") {
            		g = i.left - this.element.outerWidth()
            	}
            	else {
            		g = i.left;
            	}
    ...
    var b = {
        ...
        headTemplate: '<thead><tr><th class="prev"><i class="fa fa-arrow-left"/></th><th colspan="6" class="switch"></th><th class="next"><i class="fa fa-arrow-right"/></th></tr></thead>',
        contTemplate: '<tbody><tr><td colspan="8"></td></tr></tbody>',
        footTemplate: '<tfoot><tr><th colspan="8" class="today"></th></tr></tfoot>'
    };
